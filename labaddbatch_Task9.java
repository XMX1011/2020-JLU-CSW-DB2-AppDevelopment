...
public class labaddbatch {
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            ...
            /* of udba */
            /*******************************************************************/
            Connection sample = DriverManager.getConnection("jdbc:db2:sample", "db2admin",
                    "db2admin");
            ...
            stmt.addBatch(
                    "INSERT INTO JLU.DEPARTMENT " + "VALUES ('BT6','BATCH6 NEWYORK','BBBBB1','BTT','NEW YORK CITY6')"); // (4)
            /******************** ?????????????????? **************************/
            ...
            stmt.addBatch(
                    "INSERT INTO JLU.DEPARTMENT " + "VALUES ('BT7','BATCH7 NEWYORK','BBBBB2','BT2','NEW YORK CITY7')"); // (5)
            /******************** ?????????????????? **************************/
            ...
            stmt.addBatch(
                    "INSERT INTO JLU.DEPARTMENT " + "VALUES ('BT8','BATCH8 NEWYORK','BBBBB3','BT3','NEW YORK CITY8')"); // (6)
            ...
            stmt.addBatch(
                    "INSERT INTO JLU.DEPARTMENT " + "VALUES ('BT9','BATCH9 NEWYORK','BBBBB4','BT4','NEW YORK CITY9')"); // (7)
            ...
            stmt.addBatch(
                    "INSERT INTO JLU.DEPARTMENT " + "VALUES ('BTA','BATCH10 NEWYORK','BBBBB5','BT5','NEW YORK CITY10')"); // (8)
