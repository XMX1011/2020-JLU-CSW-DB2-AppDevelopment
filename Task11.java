...
public class Task11 {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        sql1 = "SELECT POSSTR(RESUME,'Personal') " + "FROM JLU.EMP_RESUME "
        ...
        sql2 = "SELECT POSSTR(RESUME,'Department') " + "FROM JLU.EMP_RESUME "
                + "WHERE EMPNO = ? AND RESUME_FORMAT = 'ascii' ";
        ...
        sql3 = "SELECT EMPNO, RESUME_FORMAT, " + "SUBSTR(RESUME,1,?)|| SUBSTR(RESUME,?) AS RESUME " + "FROM JLU.EMP_RESUME "
                + "WHERE EMPNO = ? AND RESUME_FORMAT = 'ascii' ";
